...
<title>WOORIAT CMS MANAGEMENT</title>
...
<%--<script src="/customJS/jquery.twbsPagination.js" type="text/javascript"></script>--%>


<%--<style>--%>
<%--    .wrapper_paging { clear: left; float: left; position: relative; left: 40%; }--%>
<%--</style>--%>
