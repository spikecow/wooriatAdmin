...
<body class="hold-transition skin-blue sidebar-mini">
                            ...
                            <table class="table table-striped" id="regionTable">
                                ...
                                <c:forEach items="${list.content}" var="list" varStatus="status">
                                    <tr class="text-center">
                                        ...
                                        <td style = "cursor:pointer;" onClick = "location.href='/popup/detail/${ list.popupId }' ">
                                            ${list.popupTitle}
                                        </td>
                                        <td>
                                            <fmt:parseDate value="${ list.popupStrtDt }" pattern="yyyy-MM-dd'T'HH:mm" var="popupStrtDt" type="both" />
                                            <fmt:formatDate pattern="yyyy.MM.dd HH:mm" value="${ popupStrtDt }" />
                                            &nbsp;~&nbsp;
                                            <fmt:parseDate value="${ list.popupEndDt }" pattern="yyyy-MM-dd'T'HH:mm" var="popupEndDt" type="both" />
                                            <fmt:formatDate pattern="yyyy.MM.dd HH:mm" value="${ popupEndDt }" />
                                        </td>
                                        <td>
                                            ${list.userInfo.userNm}
                                        </td>
                                        <td>
    ...
    <script type="text/javascript">
        ...
        $('button[name=btnRegist]').on('click', function () {
            location.href = "/popup/createForm/"
        });
