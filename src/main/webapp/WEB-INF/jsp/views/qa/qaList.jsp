...
<div class="wrapper">
                            ...
                            <table class="table table-striped table-hover" id="regionTable">
                                ...
                                <c:forEach items="${list.content}" var="list" varStatus="status">
                                    <tr class="text-center">
                                        ...
                                        <td style = "cursor:pointer;" onClick = "location.href='/qa/detail/${ list.qid }' ">
                                                ${list.title}
                                        </td>
                                        <td>
                                                ${list.name}
                                        ...
                                        <td>
                                            <c:if test="${list.answers.size() ne 0}">답변완료</c:if>
                                            <c:if test="${list.answers.size() eq 0}">문의중</c:if>
                                        </td>
                                        <td>
    ...
    <script type="text/javascript">
        ...
        $('button[name=btnViewDetail]').on('click', function () {
            location.href = "/qa/detail/"+$(this).attr('data-id');
        });
    </script>
