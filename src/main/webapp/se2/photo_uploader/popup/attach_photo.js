...
//    	//sUploadURL= 'pr/insert'; 	//upload URL
//    	sUploadURL= '/pr/fileinsert'; 	//upload URL
//    	
//    	//파일을 하나씩 보내고, 결과를 받음.
...
//	}
    ...
    function html5Upload() {	
    	var tempFile,
    		sUploadURL;
    	sUploadURL= '/notice/fileinsert'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			...
 			sUrl	: '/pr/fileinsert',	//Root 경로부터 해야한다.
 	...
 	jindo.$Ajax.prototype.request = function(oData) {
 		...
 		if (opt.sendheader) {
 			if(!this._headers["Content-Type"]){
 				...
 				//req.setRequestHeader("Content-Type", "multipart/form-data; boundary=--------287032381131322");
 			}
